...
public abstract class SistakaPanel extends JPanel {
    ...
    public static Font fontButton = new Font("Helvetica", Font.BOLD , 12);
    public static Font fontGeneral = new Font("Helvetica", Font.PLAIN , 13);
    public static Font fontTitle = new Font("Helvetica", Font.BOLD, 22);
